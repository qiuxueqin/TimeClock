...
public class ItemService {
    private final JdbcTemplate jdbc; private final TaskService tasks; private final IdempotencyService idempotency;
    public ItemService(JdbcTemplate jdbc, TaskService tasks, IdempotencyService idempotency) { this.jdbc=jdbc; this.tasks=tasks; this.idempotency=idempotency; }
