...
public class ItemController {
 ...
 @PostMapping("/api/v1/tasks/{taskId}/items/paste-confirm") public ResponseEntity<?> confirm(@PathVariable String taskId,@Valid @RequestBody PasteConfirmRequest q,Authentication a){return ok(service.confirm(uid(a),taskId,q));}
